...
Configuration of bash is via the `.bashrc` file, which lives in your: `~` (home directory).

**Note:**

- The template for `.bashrc` lives in the following directory:
`/etc/skel/.bashrc`
...
| log out and back in | Exit and relaunch |
